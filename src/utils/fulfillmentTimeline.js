...
export function fulfillmentListLabel(order) {
  ...
  if (fulfillment && fulfillment !== 'unfulfilled' && fulfillmentLabels[fulfillment]) {
    return fulfillmentLabels[fulfillment];
  }
  ...
  if (isShipmentCreatedSuccess(ship)) {
    return 'Shipment Created';
  }
  if (hasNonEmpty(order.waybill)) return 'Ready to Ship';
  return fulfillmentLabels[fulfillment] || 'Unfulfilled';
}
